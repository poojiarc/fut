    ...
    <>
      ...
      <section className="gradient-bg py-16 md:py-20">
        <div className="section-container text-left text-primary-foreground">
          ...
          <p className="text-cyan text-sm font-semibold uppercase tracking-widest mb-2">
            What We Do
          </p>
          ...
          <p className="text-primary-foreground/80 max-w-2xl mt-4">
            At Futunir Global Pvt Ltd, we provide end-to-end engineering design and
            support services, tailored to meet project-specific requirements
            across industries.
          </p>
        </div>
      </section>
