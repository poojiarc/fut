    ...
    <>
      ...
      <section className="relative h-72 md:h-96 overflow-hidden">
        ...
        <div className="relative z-10 h-full flex items-center">
          <div className="section-container text-primary-foreground">
            <p className="text-cyan text-sm font-semibold uppercase tracking-widest mb-2">How We Work</p>
            <h1 className="font-display text-4xl md:text-5xl font-bold">Our Remote-First Engineering Model</h1>
          </div>
        </div>
      </section>
      ...
      <section className="section-padding bg-muted">
        <div className="section-container">
          <div className="text-center mb-10">
            ...
            <h2 className="font-display text-3xl font-bold text-foreground">Engineering Without Boundaries</h2>
      ...
      <section className="section-padding bg-card">
        <div className="section-container max-w-3xl mx-auto">
          <div className="text-center mb-10">
            <Heart className="h-10 w-10 text-secondary mx-auto mb-3" />
            <h2 className="font-display text-3xl font-bold text-foreground">Work–Life Balance Enables Better Engineering</h2>
      ...
      <section className="section-padding bg-muted">
        <div className="section-container max-w-3xl mx-auto">
          <div className="text-center mb-10">
            ...
            <h2 className="font-display text-3xl font-bold text-foreground">Quality & Accountability Remain Non-Negotiable</h2>
            <p className="text-muted-foreground mt-3">
